...
@section('judul_halaman', 'Cetak Per Tanggal')
                    ...
                    <div class="card-deck">
                        <div class="card ">
                            <a class="btn btn-success" href="{{route('temperature.view')}}"
                                style="position: absolute;margin-top:20px;margin-left:20px;">Back</a>
                            ...
                            <div class="card-body">
                                ...
                                <a href=""
                                    ...
                                    class="btn btn-success mt-4" style="width: 100%; ">Print</a>
                                <br><br>
                            </div>
                        </div>
                    </div>
