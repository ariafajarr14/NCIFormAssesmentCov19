        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="container my-1">
                        <div class="question ml-sm-5 pl-sm-5 pt-2">
                            ...
                            <div id="options">
                                <label class="options">Ya <input type="radio" name="quest_two" value="Ya"> <span
                                        class="checkmark"></span> </label>
                                <label class="options">Tidak <input type="radio" name="quest_two" value="Tidak"> <span
                                        class="checkmark"></span> </label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-4">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="container my-1">
                        <div class="question ml-sm-5 pl-sm-5 pt-2">
                            <div class="py-2 h5"><b>3. Apakah pernah melakukan perjalanan ke luar kota/internasional?
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-4">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="container my-1">
                        <div class="question ml-sm-5 pl-sm-5 pt-2">
                            <div class="py-2 h5"><b>4. Apakah anda mengikuti kegiatan yang melibatkan orang banyak?</b>
                            </div>
                            <div id="options">
                                <label class="options">Ya <input type="radio" name="quest_four" value="Ya"> <span
                                        class="checkmark"></span> </label>
                                <label class="options">Tidak <input type="radio" name="quest_four" value="Tidak"> <span
                                        class="checkmark"></span> </label>
                            </div>
                        </div>
                    </div>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg mt-4">
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="container my-1">
                        <div class="question ml-sm-5 pl-sm-5 pt-2">
                            <div class="py-2 h5"><b>5. Apakah memiliki riwayat kontak erat dengan orang yang dinyatakan
                                    ODP, PDP atau konfirm COVID-19 (berjabat tangan, berbicara, berada dalam satu
                                    ruangan/ satu rumah)?</b></div>
                            <div id="options">
                                <label class="options">Ya <input type="radio" name="quest_five" value="Ya"> <span
                                        class="checkmark"></span> </label>
                                <label class="options">Tidak <input type="radio" name="quest_five" value="Tidak"> <span
                                        class="checkmark"></span> </label>
                            </div>
                        </div>
                    </div>
                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <div class="container my-1">
                        <div class="question ml-sm-5 pl-sm-5 pt-2">
                            ...
                            <div id="options">
                                <label class="options">Ya <input type="radio" name="quest_six" value="Ya"> <span
                                        class="checkmark"></span> </label>
                                <label class="options">Tidak <input type="radio" name="quest_six" value="Tidak"> <span
                                        class="checkmark"></span> </label>
                            </div>
                        </div>
                    </div>
